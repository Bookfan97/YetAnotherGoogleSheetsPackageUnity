...
namespace Editor.Data
{
    ...
    public class GoogleSheetsJSONData
    {
        ...
        {
            return sheets.FirstOrDefault(sheetData => sheetData.GetKey() == dataItemKey);
        }
        ...
        {
            return propertiesSheetId != null && sheets.Any(sheet => sheet.GetKey() == propertiesSheetId);
        }
    ...
    public class SheetData
    {
        ...
        /// </summary>
        [SerializeField] public List<CSVData> csvDatas = new();
        ...
        public bool CheckGUID(int i)
        {
            return csvDatas.Any(data => data.line == i);
        }
