...
namespace Editor.ScriptableObjectConverter
{
     ...
     * Gets all DialogueSO objects and converts data to CSV format
     #1#
        public void CSVtoScriptableObjects(string csvPath, bool? skipPopups = false)
        {
            int counter = 0;
            ...
            foreach (ScriptableObject SOName in dialogues)
            {
                if ((bool)!skipPopups)
                {
    ...
    var folder = Application.persistentDataPath;
        ...
        {
            CSVtoScriptableObjects(dataItem.value);
        }
    }
}
*/
