...
namespace Editor.Google_Sheets
{
    ...
    public class GoogleSheetsHelper
    {
        ...
        /// <summary>
        ///     Constant string representing the preference key for enabling or disabling debug logs related to Google Sheets
        ...
        public static Type CheckType(string typeName)
        {
            ...
            settings.LoadScriptableObjects();
            if (settings.scriptableObjects == null)
            {
                Debug.LogError("GoogleSheetsCustomSettings.scriptableObjects is null");
                return null;
            }

            return (from typePair in settings.scriptableObjects
